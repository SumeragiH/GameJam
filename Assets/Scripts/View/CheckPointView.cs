...
public class CheckPointView : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        checkPointData.SetCheckPointData(Vector2.zero, 0);
    }
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            Debug.Log("触发检查点");
            checkPointData.SetCheckPointData(PlayerView.Instance.transform.position, CollectionSystem.Instance.stageScanPoint);
